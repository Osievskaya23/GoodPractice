package carmanipulations.manager;

import carmanipulations.Car;
import carmanipulations.CarDoor;
...
public class CarManager {
    ...
    private Car createDefaultCar() {
        System.out.println(ENTER_CAR_DATE_OF_MANUFACTURE);
    ...
    private Car createNewCar() {
        System.out.println(ENTER_CAR_PARAMETERS);
        Scanner scanner = new Scanner(System.in);
    ...
    public Car checkCar(Car car) {
        ...
        if (scanner.nextLine().equals("need changes")) {
            System.out.println(CHANGES_LIST);
            String command;
